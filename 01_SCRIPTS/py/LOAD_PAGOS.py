    ...
    def loadPagos(ip, user_, password, bbdd):
        ...
        try:
            ...
            try:
                ...
                disable_key2 = "ALTER TABLE tb_pagos_movistar_ciclos drop index id_clase;"
                cursor.execute(set1)
                cursor.execute(set2)
            ...
            try:
                ...
                enable_key1 = "ALTER TABLE `bbdd_cs_bog_movistar_ciclos`.`tb_pagos_movistar_ciclos` ADD INDEX `id_cliente` USING BTREE (`cod_cliente`, `fecha_pago` DESC) VISIBLE;"
                enable_key2 = "ALTER TABLE `bbdd_cs_bog_movistar_ciclos`.`tb_pagos_movistar_ciclos` ADD INDEX `id_clase` USING HASH (`clase_pago`) VISIBLE;"
